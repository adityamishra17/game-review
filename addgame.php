...
?>
  ...
  <p class="lead text-center">Please add your desired  video game</p>
  <div class="col-xs-8 col-xs-offset-2">
    <form class="form-horizontal" role="form" action="processgame.php" method="get" enctype="text/plain">
      ...
      <div class="form-group">
        <label for="gameBio" class="col-sm-3 control-label">About Game</label>
        <div class="col-sm-9">
          <textarea type="email" class="form-control" id="gameBio" name="bio" rows="4" placeholder="about Game" required></textarea>
        </div>
      </div>
     <div class="form-group">
